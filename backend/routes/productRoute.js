...
const { getAllProduct, getProductById, getProductByCategory, getProductCategory, deleteProduct, createProduct, updateProduct, productReview } = require('../controller/productController')
